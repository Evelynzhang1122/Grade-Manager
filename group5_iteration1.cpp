...
int main()
{
    string Name, Class, weightChoice, choice;
...
// Find the percentage/points required to get each letter grade
        ...
        // Grade Placement after final grade is calculated
            if (totalScore >= GradeA) {
                cout << "You have an A in this course." << endl;
            } else if (totalScore < GradeA && totalScore >= GradeB) {
                cout << "You have a B in this course." << endl;
            } else if (totalScore < GradeB && totalScore >= GradeC) {
                cout << "You have a C in this course." << endl;
            } else if (totalScore < GradeC && totalScore >= GradeD) {
                cout << "You have a D in this course." << endl;
            } else if (totalScore < GradeD) {
                cout << "You have a F in this course." << endl;
            }
